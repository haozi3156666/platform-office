...
return [
	...
	*/
	...
	'description' => 'Excel Word CSV PDF writers and readers for Cartalyst Platform',
	...
	*/
	...
	'providers' => [
		'Sanatorium\Office\Providers\OfficeServiceProvider'
	],
	...
	*/
	...
	'menus' => [
		...
		'admin' => [
			...
			[
				'slug'  => 'admin-sanatorium-office',
				'name'  => 'Office',
				'class' => 'fa fa-circle-o',
				'uri'   => 'office',
				'regex' => '/:admin\/office/i',
			],
    ...
    */
	...
	'integrity' => [
		...
		[
			...
			'test' => ['Sanatorium\Office\Providers\OfficeServiceProvider', 'checkExcel'],

		],

		[

			'name' => 'barryvdh/dompdf is available',
			'test' => ['Sanatorium\Office\Providers\OfficeServiceProvider', 'checkPDF'],
